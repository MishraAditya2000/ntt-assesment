...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">NTT-Laundry Management</a>
              ...
              <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="./laundryrequest.html">Laundry Request</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="row">
                <div class="col">
                  <div class="card border-primary mb-3" style="max-width: 20rem;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Last Order:06-01-23</p>
                    </div>
                    <div class="card-body">
                ...
                <div class="col">
                  <div class="card border-dark mb-3" style="max-width: 20rem;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Accepted On:15-01-23</p>
                    </div>
                    <div class="card-body">
                      <a href="#" class="card-link">View Details</a>
                ...
                <div class="col">
                  <div class="card border-warning mb-3" style="max-width: 20rem;">
                    <div class="card-header"></div>
                    <div class="card-body">
                      <h4 class="card-title">In Process</h4>
                      <p class="card-text">Move for Processing On:10-01-23</p>
                    </div>
                    <div class="card-body">
                      <a href="#" class="card-link">View Details</a>
                ...
                <div class="col">
                  <div class="card border-success mb-3" style="max-width: 20rem;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Last Delivered On: 12-01-23</p>
                    </div>
                    <div class="card-body">
                      <a href="#" class="card-link">View Details</a>
                    </div>
